                    ...
                    <div class="row g-4">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control project-input" name="name" id="name" required
                                minlength="3" maxlength="100" value="{{ $type->name }}">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control project-input project-textarea" placeholder="Briefly describe your project"
                                name="description" id="description" required minlength="10" maxlength="1000" rows="5"> {{ $type->description }}</textarea>
                        </div>
                    </div>
